...
public class EtsyStepDefinitions {
    ...
    public void user_should_see_title_is_as_expected() {
        String actaualTitle= Driver.getDriver().getTitle();
    ...
    public void userSearchesInTheSearchBox(String kasik) {
    ...
    public void userShouldSeeInTheEtsyTitle(String kasigintitlesi) {
        String actualTitle = Driver.getDriver().getTitle();

        Assert.assertTrue(actualTitle.contains(kasigintitlesi));
